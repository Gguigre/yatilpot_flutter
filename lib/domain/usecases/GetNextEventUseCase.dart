...
class GetNextEventUseCase extends GetEventUseCase<Null> {
  EventRepository repository;

  GetNextEventUseCase(this.repository);
  ...
  Future<Stream<GetEventUseCaseResponse>> buildUseCaseStream(
    ...
    try {
      ...
      Event nextEvent = events.firstWhere((event) => event.start.isAfter(now));
